package caurina.transitions
{
   ...
   public class Tweener
   {
      ...
      {
         var _loc4_:SpecialPropertyModifier = null;
         if(!_inited)
         {
            init();
         }
         _loc4_ = new SpecialPropertyModifier(param2,param3);
      ...
      {
         var _loc6_:SpecialProperty = null;
         if(!_inited)
         {
            init();
         }
         _loc6_ = new SpecialProperty(param2,param3,param4,param5);
      ...
      public static function addCaller(param1:Object = null, param2:Object = null) : Boolean
      {
         ...
         _loc6_ = isNaN(_loc5_.time) ? 0 : Number(_loc5_.time);
         _loc7_ = isNaN(_loc5_.delay) ? 0 : Number(_loc5_.delay);
      ...
      {
         var _loc3_:TweenListObj = null;
         var _loc4_:TweenListObj = null;
         var _loc5_:uint = 0;
         var _loc6_:String = null;
         var _loc7_:Boolean = false;
         _loc3_ = _tweenList[param1];
         _loc4_ = _loc3_.clone(false);
         _loc5_ = 0;
      ...
      {
         var _loc2_:TweenListObj = null;
         var _loc3_:Number = NaN;
         _loc2_ = _tweenList[param1];
         if(_loc2_ == null || !_loc2_.isPaused)
         {
            return false;
         }
         _loc3_ = getCurrentTweeningTime(_loc2_);
      ...
      public static function addTween(param1:Object = null, param2:Object = null) : Boolean
      {
         ...
         _loc7_ = TweenListObj.makePropertiesChain(param2);
         if(!_inited)
         {
            init();
         }
         ...
         _loc8_ = isNaN(_loc7_.time) ? 0 : Number(_loc7_.time);
         _loc9_ = isNaN(_loc7_.delay) ? 0 : Number(_loc7_.delay);
         _loc10_ = new Array();
         _loc11_ = {
            "overwrite":true,
            "time":true,
      ...
      {
         var _loc4_:SpecialPropertySplitter = null;
         if(!_inited)
         {
            init();
         }
         _loc4_ = new SpecialPropertySplitter(param2,param3);
