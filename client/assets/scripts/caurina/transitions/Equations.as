package caurina.transitions
{
   public class Equations
   {
      ...
      public static function easeInOutElastic(param1:Number, param2:Number, param3:Number, param4:Number, param5:Object = null) : Number
      {
         ...
         _loc6_ = !Boolean(param5) || isNaN(param5.period) ? param4 * (0.3 * 1.5) : Number(param5.period);
         _loc8_ = !Boolean(param5) || isNaN(param5.amplitude) ? 0 : Number(param5.amplitude);
      ...
      {
         var _loc6_:Number = NaN;
         _loc6_ = !Boolean(param5) || isNaN(param5.overshoot) ? 1.70158 : Number(param5.overshoot);
         param1 = param1 / (param4 / 2);
         if(param1 < 1)
         {
      ...
      public static function easeInElastic(param1:Number, param2:Number, param3:Number, param4:Number, param5:Object = null) : Number
      {
         ...
         _loc6_ = !Boolean(param5) || isNaN(param5.period) ? param4 * 0.3 : Number(param5.period);
         _loc8_ = !Boolean(param5) || isNaN(param5.amplitude) ? 0 : Number(param5.amplitude);
         if(!Boolean(_loc8_) || _loc8_ < Math.abs(param3))
         {
            _loc8_ = param3;
